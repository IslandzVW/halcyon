namespace Nwc.XmlRpc
{
  ...
  public class XmlRpcRequest
  {
    ...
    public Object Invoke(String url)
      {
	XmlRpcResponse res = Send(url, 30000);
    ...
    static readonly HttpRequestCachePolicy SendCachePolicy = new HttpRequestCachePolicy(HttpRequestCacheLevel.NoCacheNoStore);
    ...
    request.CachePolicy = SendCachePolicy;
