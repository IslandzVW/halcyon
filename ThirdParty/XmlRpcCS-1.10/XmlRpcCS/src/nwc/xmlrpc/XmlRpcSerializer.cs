namespace Nwc.XmlRpc
{
  ...
  public class XmlRpcSerializer : XmlRpcXmlTokens
  {
    ...
    virtual public void Serialize(XmlWriter output, Object obj)
      {
      }
    ...
    public String Serialize(Object obj)
      {
          using (MemoryStream outStream = new MemoryStream())
          {
              ...
              XmlWriter xml = XmlWriter.Create(outStream, settings);
              Serialize(xml, obj);
              xml.Flush();

              String returns = System.Text.Encoding.UTF8.GetString(outStream.GetBuffer(), 0, (int)outStream.Length);
              xml.Close();
              return returns;
          }
      }
